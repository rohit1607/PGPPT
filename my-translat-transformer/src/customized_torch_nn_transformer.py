...
class TransformerEncoderLayer(Module):
    ...
    def _sa_block(self, x: Tensor,
        ...
        x, attn_weights = self.self_attn(x, x, x,
                    attn_mask=attn_mask,
                    key_padding_mask=key_padding_mask,
                    need_weights=True, is_causal=is_causal)  #EDIT: making need_weigths=True
        self.enc_att_scores = attn_weights #EDIT: added line to capture attention scores
...
class TransformerDecoderLayer(Module):
    ...
    def _sa_block(self, x: Tensor,
        ...
        x, attn_weights = self.self_attn(x, x, x,
                    ...
                    key_padding_mask=key_padding_mask,
                    need_weights=True, is_causal=is_causal)  #EDIT: making need_weigths=True
        self.dec_att_scores = attn_weights #EDIT: added line to capture attention scores
        return self.dropout1(x)
    ...
    def _mha_block(self, x: Tensor, mem: Tensor,
        ...
        x, attn_weights = self.multihead_attn(x, mem, mem,
                                ...
                                key_padding_mask=key_padding_mask,
                                is_causal=is_causal,
                                need_weights=True) #EDIT: making need_weigths=True
        self.dec_cross_att_scores = attn_weights #EDIT: added line to capture attention scores
        return self.dropout2(x)
